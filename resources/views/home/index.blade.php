            ...
            <div class="about-cards">
                <div class="about-cards__item">
                    ...
                    <p class="about-cards__text">{{ __('Опыт работы') }}<br>
                        <b>{{ __('с') }} <span class="about-cards__highlight">2001</span> {{ __('года') }}</b> 
                    </p>
                </div>
                ...
                <div class="about-cards__item">
                    ...
                    <p class="about-cards__text">{{ __('Производство по') }}<br>
                        <b>{{ __('стандартам') }} <span class="about-cards__highlight">{{ __('GMP') }}</span></b> 
                    </p>
                </div>

                <div class="about-cards__item">
                    <p class="about-cards__counter">3</p>
                    <p class="about-cards__text">{{ __('Более') }} <b><span class="about-cards__highlight">100</span><br>
                        {{ __('продуктов') }}</b> 
                    </p>
                </div>
                ...
                <div class="about-cards__item">
                    ...
                    <p class="about-cards__text">{{ __('Более') }}<span class="about-cards__highlight"> <b>15</span><br>
                        {{ __('категорий') }}</b> 
                    </p>
                </div>
            </div>
